...
var setup = function(x, _callback) {
	switch(x) {
		...
		case 3:
			...
			break;
		case 4:
			database.createJob(data.jobdetails0);
			database.createJob(data.jobdetails1);
			database.createJob(data.jobdetails2);
			break;
		default: 
			break;
	}
...
var createMenu = function() {
	...
	console.log("2. Setup");
	console.log("3. Get all private jobs");
	console.log("4. Get all private jobs for a particular user");
}
	...
	rl.question("Enter your option: ", function(option){
		switch(option) {
			...
			case "2":
				...
				break;
			case "3":
				database.getPrivateJobs();
				break;
			case "4":
				database.getJobRequests(1);
				break;
			default:
				test();
				break;
